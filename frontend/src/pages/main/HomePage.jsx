    ...
    <div>
      ...
      <div className="bg-gray-200 min-h-screen p-8">
          ...
          <div className="flex space-x-4 justify-center">
            {brands.map((brand) => (
              <div key={brand.id} className="flex-shrink-0 w-32 h-56 bg-gray-800 rounded-lg flex items-center justify-center">
                <img src={brand.image} alt="brand-image" style={{ height: "230px" }} />
              </div>
            ))}
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 justify-center">
